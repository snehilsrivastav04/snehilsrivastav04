...
# 👋 Hey there! I'm Snehil Srivastav

### 🌍 Data Scientist | 💻 Software Developer | 🌱 Climate Tech Enthusiast
...
```python
class SnehilSrivastav:
    def __init__(self):
        self.name = "Snehil Srivastav"
        self.role = "Data Scientist & Software Developer"
        self.location = "India 🇮🇳"
        self.passions = ["Climate Tech", "AI/ML", "Data Visualization"]
        self.currently_learning = ["Deep Learning", "MLOps", "Advanced Web Dev"]
...
🔭 **Current Focus:** Building climate change prediction models using Google Earth Engine & AQI datasets  
🌱 **Learning Journey:** Advanced ML/DL techniques, scalable data pipelines, and cloud architectures  
👯 **Open to Collaborate:** Climate analysis, data visualization, AI-driven sustainability solutions  
💡 **Seeking Help With:** Optimizing large-scale deep learning pipelines for production  
💬 **Ask Me About:** Python, SQL, Machine Learning, Data Engineering, Climate Tech  
...
I'm always excited to connect with fellow developers, data scientists, and climate tech enthusiasts! Whether you want to collaborate on a project, discuss ideas, or just chat about technology and sustainability, feel free to reach out.

[![LinkedIn](https://img.shields.io/badge/Let's_Connect_on_LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/snehil-srivastav-38818b229/)
[![Email](https://img.shields.io/badge/Send_me_an_Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:snehilsri925@gmail.com)

### 💭 *"Data is the new oil, but insights are the fuel for change."*
